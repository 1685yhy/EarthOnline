...
namespace EarthOnline.Editor
{
    ...
    {
        // npcId 字符串 → NPCID 枚举映射表
        private static readonly System.Collections.Generic.Dictionary<string, NPCID> s_npcIdToEnum = new()
        {
            {"npc_zhang_001", NPCID.ZhangLao},
            {"npc_wang_001", NPCID.WangTiezhu},
            {"npc_li_001", NPCID.LiLinger},
            {"npc_chen_001", NPCID.ChenBanxian},
            {"npc_zhao_001", NPCID.ZhaoZhanggui},
            {"npc_mystic_001", NPCID.YunyouDaoren},
            {"npc_guard_001", NPCID.ShouweiDuizhang},
            {"npc_liu_001", NPCID.LiuLiehu},
            {"npc_miner_001", NPCID.LaoKuanggong},
            {"npc_apprentice_001", NPCID.XiaoYaotong},
        };
        ...
        public static void SetupScene()
        {
            ...
            CreateEnemy("Enemy_Necromancer", new Vector3(0, 2f, -35), "necro_001", "死灵法师", maxHP: 350, attack: 40, speed: 1.5f, detect: 20f, patrol: 5f, dropId: "item_void_crystal", dropName: "虚空结晶", dropQty: 3, color: new Color(0.05f, 0.02f, 0.05f));
            CreateEnemy("Enemy_Archon", new Vector3(35, 3f, 35), "archon_001", "大天使", maxHP: 700, attack: 65, speed: 4f, detect: 30f, patrol: 12f, dropId: "item_titan_core", dropName: "泰坦核心", dropQty: 2, color: new Color(0.9f, 0.85f, 0.5f));
            CreateEnemy("Enemy_Abyssal", new Vector3(-35, 1f, 35), "abyss_001", "深渊领主", maxHP: 1000, attack: 85, speed: 1f, detect: 35f, patrol: 5f, dropId: "item_void_heart", dropName: "虚空之心", dropQty: 1, color: new Color(0.01f, 0.01f, 0.02f));
// BATCH: 7 enemies at once
            CreateEnemy("Enemy_VoidLord", new Vector3(40, 5f, 0), "voidlord_001", "虚空领主", maxHP: 2000, attack: 120, speed: 2f, detect: 50f, patrol: 10f, dropId: "item_void_heart", dropName: "虚空之心", dropQty: 3, color: new Color(0.02f, 0.0f, 0.05f));
            CreateEnemy("Enemy_ThunderBird", new Vector3(-40, 8f, 0), "thunder_001", "雷鸟", maxHP: 600, attack: 70, speed: 8f, detect: 40f, patrol: 25f, dropId: "item_phoenix_feather", dropName: "凤羽", dropQty: 3, color: new Color(0.9f, 0.8f, 0.1f));
            CreateEnemy("Enemy_FrostGiant", new Vector3(-40, 10f, -40), "frost_001", "冰霜巨人", maxHP: 1500, attack: 90, speed: 1f, detect: 20f, patrol: 5f, dropId: "item_titan_core", dropName: "泰坦核心", dropQty: 3, color: new Color(0.6f, 0.8f, 1f));
            CreateEnemy("Enemy_ShadowDragon", new Vector3(40, 8f, -40), "shadowdragon_001", "暗影龙", maxHP: 1800, attack: 110, speed: 5f, detect: 40f, patrol: 15f, dropId: "item_dragon_fang", dropName: "龙牙", dropQty: 5, color: new Color(0.05f, 0.02f, 0.08f));
            CreateEnemy("Enemy_BloodGolem", new Vector3(0, 2f, -40), "bloodgolem_001", "血魔像", maxHP: 800, attack: 55, speed: 2f, detect: 15f, patrol: 5f, dropId: "item_void_crystal", dropName: "虚空结晶", dropQty: 5, color: new Color(0.6f, 0.05f, 0.05f));
            CreateEnemy("Enemy_WorldEater", new Vector3(0, 15f, -50), "worldeater_001", "吞星巨兽", maxHP: 5000, attack: 200, speed: 0.3f, detect: 100f, patrol: 0f, dropId: "item_void_heart", dropName: "虚空之心", dropQty: 5, color: new Color(0.0f, 0.0f, 0.0f));
            CreateEnemy("Enemy_VoidPrince", new Vector3(-50, 3f, 0), "voidprince_001", "虚空王子", maxHP: 2500, attack: 130, speed: 4f, detect: 40f, patrol: 10f, dropId: "item_void_heart", dropName: "虚空之心", dropQty: 3, color: new Color(0.1f, 0.0f, 0.2f));
            CreateEnemy("Enemy_AncientDragon", new Vector3(50, 10f, 50), "ancientdragon_001", "远古巨龙", maxHP: 4000, attack: 180, speed: 3f, detect: 50f, patrol: 20f, dropId: "item_dragon_fang", dropName: "龙牙", dropQty: 5, color: new Color(0.8f, 0.6f, 0.1f));
            CreateEnemy("Enemy_CelestialGuard", new Vector3(0, 20f, 60), "celestial_001", "天界守卫", maxHP: 3500, attack: 160, speed: 5f, detect: 60f, patrol: 15f, dropId: "item_titan_core", dropName: "泰坦核心", dropQty: 4, color: new Color(1f, 0.9f, 0.5f));
            CreateEnemy("Enemy_VoidTitan", new Vector3(-50, 20f, -50), "voidtitan_001", "虚空泰坦", maxHP: 8000, attack: 250, speed: 0.5f, detect: 100f, patrol: 0f, dropId: "item_void_heart", dropName: "虚空之心", dropQty: 10, color: new Color(0.0f, 0.0f, 0.0f));
            CreateEnemy("Enemy_VoidGeneral", new Vector3(-30, 3f, -50), "voidgen_001", "虚空将军", maxHP: 2000, attack: 100, speed: 3f, detect: 35f, patrol: 8f, dropId: "item_void_crystal", dropName: "虚空结晶", dropQty: 5, color: new Color(0.15f, 0.02f, 0.15f));
            CreateEnemy("Enemy_FallenHero", new Vector3(30, 2f, -50), "fallen_001", "堕落英雄", maxHP: 1800, attack: 90, speed: 4f, detect: 30f, patrol: 10f, dropId: "item_void_heart", dropName: "虚空之心", dropQty: 2, color: new Color(0.3f, 0.2f, 0.3f));
            CreateEnemy("Enemy_WorldGuardian", new Vector3(0, 10f, 70), "guardian_001", "世界守护者", maxHP: 5000, attack: 80, speed: 2f, detect: 50f, patrol: 0f, dropId: "item_titan_core", dropName: "泰坦核心", dropQty: 5, color: new Color(0.2f, 0.5f, 0.8f));
            CreateEnemy("Enemy_VoidSpider", new Vector3(20, 1f, -55), "voidspider_001", "虚空蛛母", maxHP: 600, attack: 50, speed: 3f, detect: 25f, patrol: 10f, dropId: "item_void_crystal", dropName: "虚空结晶", dropQty: 4, color: new Color(0.2f, 0.0f, 0.2f));
            CreateEnemy("Enemy_ChaosBeast", new Vector3(-20, 2f, -55), "chaos_001", "混沌兽", maxHP: 1200, attack: 75, speed: 5f, detect: 30f, patrol: 15f, dropId: "item_void_heart", dropName: "虚空之心", dropQty: 3, color: new Color(0.3f, 0.1f, 0.3f));
            CreateEnemy("Enemy_VoidQueen", new Vector3(0, -10f, -60), "voidqueen_001", "虚空女王", maxHP: 10000, attack: 300, speed: 1f, detect: 100f, patrol: 0f, dropId: "item_void_heart", dropName: "虚空之心", dropQty: 10, color: new Color(0.3f, 0.0f, 0.3f));
            CreateEnemy("Enemy_EarthGolem", new Vector3(40, 5f, -30), "earthgolem_001", "大地守卫", maxHP: 3000, attack: 100, speed: 2f, detect: 40f, patrol: 10f, dropId: "item_titan_core", dropName: "泰坦核心", dropQty: 5, color: new Color(0.3f, 0.5f, 0.2f));
            CreateEnemy("Enemy_StarBeast", new Vector3(-40, 8f, -30), "starbeast_001", "星辰兽", maxHP: 2500, attack: 120, speed: 6f, detect: 45f, patrol: 20f, dropId: "item_phoenix_feather", dropName: "凤羽", dropQty: 5, color: new Color(0.8f, 0.8f, 1f));
            CreateEnemy("Enemy_FinalBoss", new Vector3(0, -20f, -70), "finalboss_001", "虚空本体", maxHP: 20000, attack: 500, speed: 0.5f, detect: 200f, patrol: 0f, dropId: "item_void_heart", dropName: "虚空之心", dropQty: 20, color: new Color(0.0f, 0.0f, 0.0f));
            CreateEnemy("Enemy_PeaceKeeper", new Vector3(0, 15f, 80), "peace_001", "和平使者", maxHP: 3000, attack: 50, speed: 3f, detect: 100f, patrol: 30f, dropId: "item_phoenix_feather", dropName: "凤羽", dropQty: 5, color: new Color(1f, 1f, 1f));
            CreateEnemy("Enemy_DreamEater", new Vector3(25, 2f, -60), "dreameater_001", "梦魇吞噬者", maxHP: 1500, attack: 85, speed: 4f, detect: 35f, patrol: 10f, dropId: "item_void_crystal", dropName: "虚空结晶", dropQty: 5, color: new Color(0.1f, 0.0f, 0.1f));
            CreateEnemy("Enemy_SoulCollector", new Vector3(-25, 2f, -60), "soulcollector_001", "灵魂收集者", maxHP: 1200, attack: 70, speed: 3f, detect: 40f, patrol: 8f, dropId: "item_void_heart", dropName: "虚空之心", dropQty: 2, color: new Color(0.2f, 0.1f, 0.2f));
            CreateEnemy("Enemy_TimeWraith", new Vector3(0, 5f, -65), "timewraith_001", "时光怨灵", maxHP: 900, attack: 60, speed: 6f, detect: 50f, patrol: 15f, dropId: "item_phoenix_feather", dropName: "凤羽", dropQty: 3, color: new Color(0.5f, 0.5f, 0.8f));
            CreateEnemy("Enemy_NetherDragon", new Vector3(-35, 8f, -60), "netherdragon_001", "冥龙", maxHP: 3500, attack: 150, speed: 4f, detect: 45f, patrol: 12f, dropId: "item_dragon_fang", dropName: "龙牙", dropQty: 5, color: new Color(0.1f, 0.05f, 0.1f));
            CreateEnemy("Enemy_StormGiant", new Vector3(35, 15f, -60), "stormgiant_001", "风暴巨人", maxHP: 2800, attack: 130, speed: 2f, detect: 35f, patrol: 8f, dropId: "item_titan_core", dropName: "泰坦核心", dropQty: 4, color: new Color(0.5f, 0.5f, 0.6f));
            CreateEnemy("Enemy_VoidEater", new Vector3(-35, 1f, 60), "voideater_001", "虚空吞噬者", maxHP: 4000, attack: 180, speed: 3f, detect: 50f, patrol: 10f, dropId: "item_void_heart", dropName: "虚空之心", dropQty: 5, color: new Color(0.0f, 0.0f, 0.0f));
            CreateEnemy("Enemy_AncientWarrior", new Vector3(20, 2f, 65), "ancientwarrior_001", "古代战士", maxHP: 2000, attack: 100, speed: 3f, detect: 30f, patrol: 10f, dropId: "item_ancient_rune", dropName: "远古符文", dropQty: 3, color: new Color(0.4f, 0.35f, 0.2f));
            CreateEnemy("Enemy_ShadowStalker", new Vector3(-15, 1.5f, -60), "shadowstalker_001", "暗影追踪者", maxHP: 650, attack: 55, speed: 6f, detect: 45f, patrol: 12f, dropId: "item_void_crystal", dropName: "虚空结晶", dropQty: 3, color: new Color(0.05f, 0.02f, 0.05f));
            CreateEnemy("Enemy_FleshGolem", new Vector3(10, 3f, -65), "fleshgolem_001", "血肉魔像", maxHP: 1100, attack: 65, speed: 1.5f, detect: 20f, patrol: 5f, dropId: "item_void_crystal", dropName: "虚空结晶", dropQty: 4, color: new Color(0.5f, 0.1f, 0.1f));
            CreateEnemy("Enemy_BoneDragon", new Vector3(-30, 5f, -65), "bonedragon_001", "骨龙", maxHP: 2500, attack: 120, speed: 3f, detect: 40f, patrol: 10f, dropId: "item_dragon_fang", dropName: "龙牙", dropQty: 5, color: new Color(0.3f, 0.3f, 0.3f));
            CreateEnemy("Enemy_CrystalGolem", new Vector3(-10, 4f, -68), "crystalgolem_001", "水晶巨像", maxHP: 1600, attack: 85, speed: 1f, detect: 15f, patrol: 3f, dropId: "item_spirit_jade", dropName: "灵玉", dropQty: 5, color: new Color(0.5f, 0.7f, 0.9f));
            CreateEnemy("Enemy_RuneGolem", new Vector3(15, 5f, -68), "runegolem_001", "符文巨像", maxHP: 2000, attack: 95, speed: 0.8f, detect: 20f, patrol: 2f, dropId: "item_ancient_rune", dropName: "远古符文", dropQty: 3, color: new Color(0.6f, 0.5f, 0.3f));
            CreateEnemy("Enemy_FrostWyrm", new Vector3(-25, 6f, -68), "frostwyrm_001", "冰霜巨龙", maxHP: 2800, attack: 140, speed: 3.5f, detect: 45f, patrol: 12f, dropId: "item_dragon_fang", dropName: "龙牙", dropQty: 5, color: new Color(0.6f, 0.7f, 0.9f));
            CreateEnemy("Enemy_FlameLord", new Vector3(30, 8f, -68), "flamelord_001", "火焰领主", maxHP: 3200, attack: 160, speed: 2f, detect: 40f, patrol: 8f, dropId: "item_phoenix_feather", dropName: "凤羽", dropQty: 5, color: new Color(1f, 0.3f, 0.05f));
            CreateEnemy("Enemy_ThunderLord", new Vector3(-30, 10f, -68), "thunderlord_001", "雷霆主宰", maxHP: 3500, attack: 170, speed: 3f, detect: 50f, patrol: 10f, dropId: "item_titan_core", dropName: "泰坦核心", dropQty: 5, color: new Color(0.2f, 0.5f, 0.9f));
            CreateEnemy("Enemy_WindLord", new Vector3(35, 12f, -68), "windlord_001", "风暴主宰", maxHP: 3000, attack: 140, speed: 8f, detect: 55f, patrol: 15f, dropId: "item_phoenix_feather", dropName: "凤羽", dropQty: 5, color: new Color(0.7f, 0.8f, 0.9f));
            CreateEnemy("Enemy_EarthTitan", new Vector3(0, 12f, -72), "earthtitan_001", "大地泰坦", maxHP: 4500, attack: 200, speed: 0.5f, detect: 0f, patrol: 0f, dropId: "item_titan_core", dropName: "泰坦核心", dropQty: 5, color: new Color(0.4f, 0.3f, 0.2f));
            CreateEnemy("Enemy_DaoGuardian", new Vector3(60, 5f, 0), "daoguard_001", "道胎守护者", maxHP: 3000, attack: 0, speed: 0f, detect: 100f, patrol: 0f, dropId: "item_phoenix_feather", dropName: "凤羽", dropQty: 3, color: new Color(0.9f, 0.85f, 0.5f));
            CreateEnemy("Enemy_VoidSpawn", new Vector3(-60, 1f, -60), "voidspawn_001", "虚空幼体", maxHP: 400, attack: 35, speed: 5f, detect: 30f, patrol: 20f, dropId: "item_void_crystal", dropName: "虚空结晶", dropQty: 3, color: new Color(0.15f, 0.0f, 0.15f));
            CreateEnemy("Enemy_AncientGuardian", new Vector3(0, 8f, -75), "ancientguard_001", "远古守卫", maxHP: 5000, attack: 0, speed: 0f, detect: 80f, patrol: 0f, dropId: "item_ancient_rune", dropName: "远古符文", dropQty: 5, color: new Color(0.8f, 0.7f, 0.4f));
            CreateEnemy("Enemy_SoulEater", new Vector3(-50, 3f, -70), "souleater_001", "噬魂者", maxHP: 2500, attack: 100, speed: 3f, detect: 40f, patrol: 10f, dropId: "item_void_heart", dropName: "虚空之心", dropQty: 3, color: new Color(0.2f, 0.0f, 0.1f));
            CreateEnemy("Enemy_FateWeaver", new Vector3(50, 3f, -70), "fateweaver_001", "命运编织者", maxHP: 3500, attack: 0, speed: 0f, detect: 100f, patrol: 0f, dropId: "item_ancient_rune", dropName: "远古符文", dropQty: 5, color: new Color(0.9f, 0.9f, 0.95f));
            CreateEnemy("Enemy_VoidHerald", new Vector3(-60, 5f, -75), "voidherald_001", "虚空先驱", maxHP: 4000, attack: 150, speed: 4f, detect: 50f, patrol: 12f, dropId: "item_void_heart", dropName: "虚空之心", dropQty: 5, color: new Color(0.05f, 0.0f, 0.1f));
            CreateEnemy("Enemy_CelestialJudge", new Vector3(0, 15f, -80), "celestialjudge_001", "天界审判者", maxHP: 6000, attack: 200, speed: 2f, detect: 100f, patrol: 0f, dropId: "item_titan_core", dropName: "泰坦核心", dropQty: 10, color: new Color(1f, 0.95f, 0.8f));
            CreateEnemy("Enemy_VoidAvatar", new Vector3(0, -10f, -85), "voidavatar_001", "虚空化身", maxHP: 10000, attack: 300, speed: 2f, detect: 200f, patrol: 0f, dropId: "item_void_heart", dropName: "虚空之心", dropQty: 20, color: new Color(0.0f, 0.0f, 0.0f));
            CreateEnemy("Enemy_WorldHeart", new Vector3(0, 0f, -100), "worldheart_001", "世界之心", maxHP: 99999, attack: 0, speed: 0f, detect: 0f, patrol: 0f, dropId: "item_void_heart", dropName: "虚空之心", dropQty: 50, color: new Color(0.5f, 0.8f, 1f));
            CreateEnemy("Enemy_PrimordialVoid", new Vector3(0, -30f, -120), "primordial_001", "原始虚空", maxHP: 50000, attack: 500, speed: 0.1f, detect: 500f, patrol: 0f, dropId: "item_void_heart", dropName: "虚空之心", dropQty: 100, color: new Color(0.0f, 0.0f, 0.0f));
            CreateEnemy("Enemy_VoidMother", new Vector3(0, -50f, -200), "voidmother_001", "虚空之母", maxHP: 100000, attack: 1000, speed: 0f, detect: 1000f, patrol: 0f, dropId: "item_void_heart", dropName: "虚空之心", dropQty: 1000, color: new Color(0.0f, 0.0f, 0.0f));
            CreateEnemy("Enemy_CosmicDragon", new Vector3(0, 100f, -300), "cosmicdragon_001", "宇宙龙", maxHP: 50000, attack: 800, speed: 10f, detect: 500f, patrol: 50f, dropId: "item_void_heart", dropName: "虚空之心", dropQty: 50, color: new Color(0.1f, 0.0f, 0.3f));
            CreateEnemy("Enemy_PoisonWyrm", new Vector3(35f, 2f, -65f), "poisonwyrm_001", "毒龙", maxHP: 2000, attack: 100, speed: 2.5f, detect: 35f, patrol: 8f, dropId: "item_void_crystal", dropName: "虚空结晶", dropQty: 5, color: new Color(0.1f, 0.5f, 0.1f));
            ...
            CreateEnemy("Enemy_NewGuardian", new Vector3(30, 10f, 80), "newguard_001", "新世界守卫", maxHP: 4000, attack: 80, speed: 4f, detect: 60f, patrol: 20f, dropId: "item_titan_core", dropName: "泰坦核心", dropQty: 5, color: new Color(0.5f, 0.8f, 0.5f));
            CreateEnemy("Enemy_SolarPhoenix", new Vector3(0, 30f, 50), "solar_001", "太阳神鸟", maxHP: 3000, attack: 150, speed: 10f, detect: 60f, patrol: 30f, dropId: "item_phoenix_feather", dropName: "凤羽", dropQty: 5, color: new Color(1f, 0.8f, 0.1f));
            CreateEnemy("Enemy_Cerberus", new Vector3(-35, 2f, -35), "cerberus_001", "地狱三头犬", maxHP: 550, attack: 52, speed: 4f, detect: 22f, patrol: 8f, dropId: "item_void_crystal", dropName: "虚空结晶", dropQty: 4, color: new Color(0.3f, 0.05f, 0.05f));
            CreateEnemy("Enemy_Medusa", new Vector3(35, 2f, -20), "medusa_001", "美杜莎", maxHP: 380, attack: 42, speed: 3f, detect: 15f, patrol: 8f, dropId: "item_ancient_rune", dropName: "远古符文", dropQty: 2, color: new Color(0.1f, 0.5f, 0.2f));
            CreateEnemy("Enemy_Colossus", new Vector3(-35, 8f, 20), "colossus_001", "巨神兵", maxHP: 1200, attack: 80, speed: 0.5f, detect: 10f, patrol: 0f, dropId: "item_titan_core", dropName: "泰坦核心", dropQty: 3, color: new Color(0.7f, 0.6f, 0.4f));
            CreateEnemy("Enemy_Banshee", new Vector3(30, 2f, -25), "banshee_001", "报丧女妖", maxHP: 280, attack: 38, speed: 5f, detect: 25f, patrol: 12f, dropId: "item_void_crystal", dropName: "虚空结晶", dropQty: 3, color: new Color(0.1f, 0.1f, 0.4f));
            CreateEnemy("Enemy_Ifrit", new Vector3(-30, 2f, -25), "ifrit_001", "伊芙利特", maxHP: 420, attack: 58, speed: 3f, detect: 18f, patrol: 8f, dropId: "item_phoenix_feather", dropName: "凤羽", dropQty: 2, color: new Color(1f, 0.3f, 0.05f));
            CreateEnemy("Enemy_Wendigo", new Vector3(-28, 3f, 28), "wendigo_001", "温迪戈", maxHP: 320, attack: 45, speed: 6f, detect: 28f, patrol: 15f, dropId: "item_dragon_fang", dropName: "龙牙", dropQty: 2, color: new Color(0.9f, 0.9f, 0.95f));
            CreateEnemy("Enemy_Juggernaut", new Vector3(28, 3f, -28), "juggernaut_001", "攻城巨像", maxHP: 900, attack: 65, speed: 1f, detect: 8f, patrol: 2f, dropId: "item_titan_core", dropName: "泰坦核心", dropQty: 2, color: new Color(0.5f, 0.5f, 0.5f));
// BATCH: 7 enemies at once
...
//
            ...
            string greeting, Color color, bool isMale)
        {
            ...
            // 使用NPCVisualDatabase查配置，传给CharacterBuilder
            GameObject builtNPC = null;
            if (s_npcIdToEnum.TryGetValue(id, out NPCID npcId) && NPCVisualDatabase.TryGetConfig(npcId, out NPCVisualConfig npcConfig))
            {
                builtNPC = EarthOnline.Editor.CharacterBuilder.BuildNPC(npcConfig);
            }
            else
            {
                // 向下兼容：config不存在 → 默认参数
                ...
                builtNPC = EarthOnline.Editor.CharacterBuilder.BuildNPC(displayName, new Color(0.85f, 0.75f, 0.65f), color, role);
            }
