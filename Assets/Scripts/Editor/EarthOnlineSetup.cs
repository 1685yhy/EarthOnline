...
// BATCH: 7 enemies at once
            ...
            CreateEnemy("Enemy_BoneDragon", new Vector3(-30f, 5f, -65f), "bonedragon_001", "骨龙", maxHP: 2500, attack: 120, speed: 3f, detect: 40f, patrol: 10f, dropId: "item_dragon_fang", dropName: "龙牙", dropQty: 5, color: new Color(0.3f, 0.3f, 0.3f));
            CreateEnemy("Enemy_CrystalGolem", new Vector3(-10, 4f, -68), "crystalgolem_001", "水晶巨像", maxHP: 1600, attack: 85, speed: 1f, detect: 15f, patrol: 3f, dropId: "item_spirit_jade", dropName: "灵玉", dropQty: 5, color: new Color(0.5f, 0.7f, 0.9f));
            CreateEnemy("Enemy_RuneGolem", new Vector3(15, 5f, -68), "runegolem_001", "符文巨像", maxHP: 2000, attack: 95, speed: 0.8f, detect: 20f, patrol: 2f, dropId: "item_ancient_rune", dropName: "远古符文", dropQty: 3, color: new Color(0.6f, 0.5f, 0.3f));
            CreateEnemy("Enemy_FrostWyrm", new Vector3(-25, 6f, -68), "frostwyrm_001", "冰霜巨龙", maxHP: 2800, attack: 140, speed: 3.5f, detect: 45f, patrol: 12f, dropId: "item_dragon_fang", dropName: "龙牙", dropQty: 5, color: new Color(0.6f, 0.7f, 0.9f));
            CreateEnemy("Enemy_FlameLord", new Vector3(30, 8f, -68), "flamelord_001", "火焰领主", maxHP: 3200, attack: 160, speed: 2f, detect: 40f, patrol: 8f, dropId: "item_phoenix_feather", dropName: "凤羽", dropQty: 5, color: new Color(1f, 0.3f, 0.05f));
