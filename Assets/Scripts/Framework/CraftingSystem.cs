...
namespace EarthOnline.Framework
{
    ...
    public class CraftingManager : MonoBehaviour
    {
        ...
        void RegisterRecipes()
        {
            ...
            AddRecipe("craft_soul_bond", "灵魂羁绊", "Accessory", "SSR", 1, 7000, ("item_void_heart", 2), ("item_phoenix_feather", 2), ("item_dragon_fang", 2));
            ...
            AddRecipe("craft_soul_essence", "灵魂精华", "Consumable", "SSR", 1, 8000, ("item_void_heart", 3), ("item_phoenix_feather", 3), ("item_ancient_rune", 3));
            AddRecipe("craft_void_mother_tear", "虚空之母的泪", "Accessory", "SSR", 1, 50000, ("item_void_heart", 100), ("item_titan_core", 50), ("item_phoenix_feather", 50));
            AddRecipe("craft_cosmic_scale", "宇宙龙鳞", "Armor", "SSR", 1, 30000, ("item_void_heart", 20), ("item_dragon_fang", 20), ("item_phoenix_feather", 10));
